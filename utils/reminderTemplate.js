const sessionReminder = {
  to: `{{address}}`,
  subject: `Coding Boot Camp - Tutorial Confirmation {{timeDate}}`,
  text: `Hi {{name}}!


  Thank you for scheduling your session with me. I am looking forward to our session on {{timeDate}}.
  ...
  This session will take place here: {{link}}
